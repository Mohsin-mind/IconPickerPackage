...
var IconPicker = function IconPicker(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    updatePopupPosition();
    window.addEventListener('wheel', updatePopupPosition, {
      passive: true
    });
    return function () {
  ...
  var renderPopup = function renderPopup() {
    return /*#__PURE__*/_react["default"].createElement("div", {
      ref: popupRef,
      className: "absolute bg-white border border-gray-300 shadow-lg rounded popup-container min-w-[367px] ".concat(isPositionSet ? '' : 'invisible'),
      style: {
    ...
    }))), iconsToDisplay.length > 0 && /*#__PURE__*/_react["default"].createElement("div", {
      ...
      className: "grid grid-cols-5 grid-rows-4 gap-[2px] w-fit"
    }, iconsToDisplay.map(function (icon, index) {
      return /*#__PURE__*/_react["default"].createElement("div", {
        key: index,
        className: "w-[65px] h-[65px] flex justify-center items-center cursor-pointer group overflow-hidden ".concat(selectedIcons !== null && selectedIcons !== void 0 && selectedIcons.includes(icon) ? 'bg-blue-200' : 'bg-gray-200', " hover:bg-gray-300"),
        onClick: function onClick() {
          return handleIconClick(icon);
        }
      }, /*#__PURE__*/_react["default"].createElement(_reactFontawesome.FontAwesomeIcon, {
        icon: icon,
        className: "text-[20px] transform transition duration-200 group-hover:text-gray-600 group-hover:scale-200 ".concat(selectedIcons !== null && selectedIcons !== void 0 && selectedIcons.includes(icon) ? 'text-blue-800' : 'text-gray-800')
      }));
    }))));
  };
  return /*#__PURE__*/_react["default"].createElement("div", {
