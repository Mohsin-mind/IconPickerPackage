...
var IconPicker = function IconPicker(_ref) {
  var _ref$icons = _ref.icons,
    ...
    gridRows = _ref$gridRows === void 0 ? 3 : _ref$gridRows,
  ...
  var renderPopup = function renderPopup() {
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        key: index,
        className: classNames("flex justify-center items-center cursor-pointer group overflow-hidden ".concat(selectedIcons !== null && selectedIcons !== void 0 && selectedIcons.includes(icon) ? iconSelectedBgColor : iconBgColor, " hover:bg-gray-300")),
        style: {
